...
if __name__ == "__main__":
    print("Data injestion started.")
    start_time = time.time()
    # # Specify the file path
    file_path = r"C:\Users\0001r\Documents\GitHub\ene-ml-chasis\data\archive.zip"
    ...
    print(f"The injestion ran for {elapsed_time:.2f} seconds.")
    pass
